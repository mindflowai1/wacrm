...
export function WhatsAppConfig() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (tokenEdited && accessToken !== MASKED_TOKEN && accessToken.trim()) {
        ...
        toast.error('Informe o Token de Acesso de novo para salvar');
        setSaving(false);
        return;
      }
      ...
      if (data.registered === false && data.registration_error) {
        ...
        toast.success(
          'Credenciais salvas e verificadas. O registro de entrada foi pulado (sem PIN) — veja o status do registro abaixo.',
          { duration: 10000 },
        );
        setPin('');
      } else {
  ...
  async function handleTestConnection() {
    try {
      ...
      setConnectionStatus('disconnected');
      toast.error('Teste de conexão falhou. Verifique a rede e tente de novo.');
    } finally {
      setTesting(false);
    }
  }
  ...
  async function handleReset() {
    ...
    try {
      ...
      toast.success('Configuração limpa. Agora você pode informar suas credenciais de novo.');
      setConfig(null);
      setPhoneNumberId('');
      setWabaId('');
      setAccessToken('');
    ...
    return (
      <section className="animate-in fade-in-50 duration-200">
        <SettingsPanelHead
          ...
          description="Conecte sua API do WhatsApp Business da Meta. Credenciais, webhook e passos de configuração ficam aqui."
        />
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Informe as credenciais da sua API do WhatsApp Business da Meta.
            </CardDescription>
          </CardHeader>
            ...
            <div className="space-y-2">
              ...
              {config && !tokenEdited && (
                <p className="text-xs text-muted-foreground">
                  O token está oculto por segurança. Informe de novo para atualizar a configuração.
                </p>
              )}
            </div>

            <div className="space-y-2">
              <Label className="text-muted-foreground">Verify Token do Webhook</Label>
              <Input
              ...
              />
              <p className="text-xs text-muted-foreground">
                Um texto que você cria. Deve ser igual ao token definido nas configurações de webhook da Meta.
              </p>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Use esta URL como callback do webhook no painel do app da Meta.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
