...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  {
    id: "violet",
    name: "Violeta",
    tagline: "O padrão — confiante, com um toque descontraído.",
  ...
  },
  {
    id: "cobalt",
    name: "Cobalto",
    tagline: "Azul B2B-SaaS clean — calmo e com cara de produto.",
    swatch: "oklch(0.585 0.2 254)",
  },
  {
    id: "amber",
    name: "Âmbar",
    tagline: "Quente e acolhedor — combina bem com equipes de PME.",
    swatch: "oklch(0.745 0.16 65)",
  },
  {
    id: "rose",
    name: "Rosa",
    tagline: "Marcante e moderno — D2C, criadores, lifestyle.",
